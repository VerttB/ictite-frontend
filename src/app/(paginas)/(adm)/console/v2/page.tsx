        ...
        <div className="flex w-full flex-col gap-8 py-4 sm:px-8">
            ...
            <div className="bg-primary mx-4 mt-4 flex flex-col gap-3 rounded-md border border-blue-100 p-4 text-white shadow-sm">
                ...
                <p className="text-sm sm:text-base">
                    Painel administrativo do ICTITE, onde poderá ser cadastrado e
                    gerenciado os dados do ICTITE.
                </p>
            </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div>
                        <ul className="list-outside list-decimal space-y-2 pl-5">
                            ...
                            <li>
                                Precione o botão de <strong>Adicionar</strong>, sendo
                                exemplificado com o sinal de '+'.
                            </li>
                            <li>
                            ...
                            <li>
                                Caso tenha entidade filhos, cadastra-os e clique em{" "}
                                <strong>Criar</strong>.
                            </li>
                            <li>
                                Ao final, voltará para a página de{" "}
                                <strong>Console da entidade salva</strong> e será listada.
                            </li>
                            <li>
                                Poderá ser visualizado todas{" "}
                                <strong>as entidade salva</strong>.
                            </li>
                            <li>
                                Fique avontade para fazer buscas e filtros em busca de uma
                                entidade específica, caso queira alterar ou excluir.
                            </li>
                        </ul>
                    </div>
                </div>
